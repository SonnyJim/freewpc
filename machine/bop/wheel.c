...
{
	lamplist_apply (LAMPLIST_LITTLE_WHEEL, lamp_off);
...
static void check_swheel_award_eb_lit (void)
{
	if (flag_test (FLAG_EB_LIT) && !swheel_fiftyk_skill_shot_collected)
	{
		//sound_send (SND_WHEEL_COLLECT);
